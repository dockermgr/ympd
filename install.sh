...
# Defaults
APPNAME="ympd"
APPDIR="$HOME/.local/share/srv/docker/ympd"
DATADIR="$HOME/.local/share/srv/docker/ympd/files"
INSTDIR="$HOME/.local/share/dockermgr/ympd"
REPO="${DOCKERMGRREPO:-https://github.com/dockermgr}/ympd"
...
SERVER_PORT_INT="${SERVER_PORT_INT:-8082}"
...
if docker ps -a | grep -qs "$APPNAME"; then
  ...
  [[ -n "$SERVER_WEB_PORT" ]] && printf_blue "and should be available at: http://$SERVER_LISTEN:$SERVER_PORT_OTHER or http://$SERVER_HOST:$SERVER_PORT_OTHER"
